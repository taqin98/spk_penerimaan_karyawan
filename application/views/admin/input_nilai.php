...
<body>
    ...
    <div id="appCapsule">
        <div class="section full mt-2">
            <div class="section-title">Input Nilai Seleksi Penerimaan Karyawan</div>
            ...
            <div class="wide-block pb-1 pt-1">
                ...
                <form method="POST" action="<?= base_url('result/input') ?>">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Nomor KTP</label>
                            <!-- <input type="text" class="form-control" placeholder="Input dalam angka" name="ktpid" required="" maxlength="50" size="50"> -->
                            <select class="form-control" name="ktpid">
                                <option>-- Pilih Nomor KTP --</option>
                                <?php foreach ($data as $key): ?>
                                <option value="<?= $key->ktp_id; ?>"><?= $key->ktp_id . " - " . $this->ProfileModel->getProfile($key->ktp_id)->nama; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <i class="clear-input">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" placeholder="Input dalam angka" name="psiko" required="" maxlength="2" size="2">
                            <i class="clear-input">
                                <ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon>
                            </i>
                        </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="kes" class="form-control" placeholder="Input dalam angka" required="" maxlength="2">
                            <i class="clear-input">
                                <ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon>
                            </i>
                        </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="wawancara" class="form-control" placeholder="Input dalam angka" required="" maxlength="2" size="2">
                            <i class="clear-input">
                                <ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon>
                            </i>
                        </div>
